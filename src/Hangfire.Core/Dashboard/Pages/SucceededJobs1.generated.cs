...
WriteLiteral("\r\n");
    ...
    var pager = new Pager(from, perPage, monitor.JobCountByStateName(SucceededState.StateName, filterString, startDate, endDate), filterString, startDate, endDate);
...
"nd.\r\n            </div>\r\n");
            ...
            #line 35 "..\..\Dashboard\Pages\SucceededJobs.cshtml"
        }
        else
        {
